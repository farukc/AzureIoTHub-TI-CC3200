...
### Step-by-step instructions:
 1. **Connect your TI CC3200 to Azure IoT Hub**
  ...
  2. Create an Azure IoT Hub
   ...
   3. Connect to your Azure IoT Hub using "Device Explorer" tool and create a "device" : 
      1. Go ahead and download free tool [Azure Device Explorer](https://github.com/Azure/azure-iot-sdks/releases) and install
 ...
 4. **Create your Power BI dashboard to show telemetry data in a realtime dashboard**
   1. Login to your Power BI account in [http://www.powerbi.com](http://www.powerbi.com) and click anywhere on the left to see "hamburger button" right below 9 dot logo :<br> 
   ![](images/pbi_b_01.png)
